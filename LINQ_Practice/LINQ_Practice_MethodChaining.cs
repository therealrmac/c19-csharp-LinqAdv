...
namespace LINQ_Practice
{
    ...
    public class LINQ_Practice_MethodChaining
    {
        ...
        {
            var ActualCohorts = PracticeData.Where(c => c.FullTime == false && c.PrimaryInstructor.Active == true && c.JuniorInstructors.All(i => i.Active== true)).ToList();
        ...
        {
            var ActualCohorts = PracticeData.Where(c => c.PrimaryInstructor.FirstName== "Kate" || (c.JuniorInstructors.Any(i => i.FirstName== "Kate") || c.Students.Any(n => n.FirstName== "Kate"))).ToList();
        ...
        {
            var student = PracticeData.SelectMany(c => c.Students).OrderBy(i => i.Birthday).First();
        ...
        {
            var student = PracticeData.SelectMany(c => c.Students).OrderBy(i => i.Birthday).Last();
        ...
        {
            var ActualStudents = PracticeData.SelectMany(c => c.Students).Where(a => a.Active== false).OrderBy(i => i.LastName).ToList();
