...
namespace LINQ_Practice
{
    ...
    public class LINQ_Practice_All
    {
        ...
        {
            var doAll = PracticeData.All(i => i.PrimaryInstructor.Active== true);
        ...
        {
            var doAll = PracticeData.All(c => c.PrimaryInstructor.Active == true && c.PrimaryInstructor.FirstName.Contains("A") || c.PrimaryInstructor.FirstName.Contains("a"));
