...
namespace LINQ_Practice
{
        ...
        */
    {
        ...
        {
            var ActualCohort = PracticeData.Single(c => c.FullTime == true && c.PrimaryInstructor.Birthday > DateTime.Now);
        ...
        {
            var ActualCohort = PracticeData.SingleOrDefault(c => c.PrimaryInstructor.FirstName == "Zelda" || c.PrimaryInstructor.FirstName == null);
